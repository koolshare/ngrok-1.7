...
func assetsServerTlsSnakeoilCrt() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/server/tls/snakeoil.crt", size: 989, mode: os.FileMode(436), modTime: time.Unix(1452132613, 0)}
...
func assetsServerTlsSnakeoilKey() (*asset, error) {
	...
	info := bindataFileInfo{name: "assets/server/tls/snakeoil.key", size: 1675, mode: os.FileMode(436), modTime: time.Unix(1452132613, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
